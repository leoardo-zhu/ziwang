        ...
        value: function submit() {
            ...
            if (this.props.register) {
                fetch(baseUrl + ("/user/register/" + code), {
                    ...
                    response.flag ? window.location.href = '' : _this3.setState({ error: { flag: true, msg: response.message } });
                });
            } else {
    ...
    _createClass(AccountLogin, [{
        ...
        value: function submit() {
            ...
            fetch(baseUrl + "/user/login", {
                ...
                response.flag ? window.location.href = '' : _this5.setState({ error: { flag: true, msg: response.message } });
            });
        }
    }, {
        key: "render",
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement("input", { type: "text", id: "username", placeholder: "\u624B\u673A/\u90AE\u7BB1/\u8D44\u7F51\u8D26\u53F7", onChange: this.handleInputChange })
                ),
                React.createElement(
                    "div",
                    { className: "password" },
                    ...
                    React.createElement("input", { type: "password", id: "password", placeholder: "\u767B\u5F55\u5BC6\u7801", onChange: this.handleInputChange })
                ),
                React.createElement(
                    "a",
                    { href: "#" },
